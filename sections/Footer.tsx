...
const Footer: React.FC = () => {
  return (
    <div className='flex w-full justify-center z-50'>
      <div className='flex w-full max-w-5xl pb-4 justify-between'>

        <div className='flex items-center gap-4'>
          <p><span className='text-sm'>Autor: </span>Xavi Ramon Nicolau</p>
          <div className='flex cursor-pointer'>
            <a href="https://www.linkedin.com/in/xavi-ramon-nicolau-08289a261/" target="_blank" rel="noopener noreferrer">
          ...
          <div className='flex cursor-pointer'>
            <a href="https://github.com/xavirn89" target="_blank" rel="noopener noreferrer">
              <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" className='h-6' fill="#ffffff">
                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                <g id="SVGRepo_iconCarrier">
